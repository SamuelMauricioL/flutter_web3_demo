...
import 'package:flutter_web3_demo/common/primary_button.dart';
import 'package:flutter_web3_demo/utils/constants.dart';
import 'package:flutter_web3_demo/utils/image_constants.dart';
...
class _HomescreenState extends State<Homescreen> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    var controller = FlutterWalletConnect.instance;
                        ...
                        PrimaryButton(
                          ...
                          onPressed: () async {
                            if (_amountCtrl.text.isNotEmpty &&
                              ...
                              await controller.sendToken("", _amountCtrl.text);
                              _amountCtrl.text = "";
                              setState(() {});
